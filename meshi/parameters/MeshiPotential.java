...
public interface MeshiPotential {
    public final String HYDROGEN_BONDS_PAIRS_PARAMETERS_SURFACE = "meshiPotential/HydrogenBondsParameters.surface.dat";
    ...
    public final String EXCLUDED_VOL_PARAMETERS_IMPROVED = "meshiPotential/improvedEVparameters.dat";
    public final String ELECTROSTATICS_PARAMETERS = "meshiPotential/ElectrostaticParameters.dat";
    public final String ROT1_SOLVATE_PARAMETERS = "meshiPotential/Rot1SolvateCoarse";
    public final String ROT1_PAIRWISE_PARAMETERS = "meshiPotential/Rot1SolvateCoarse/Pairwise_Rot1.dat";
    public final String CB_PAIRWISE_PARAMETERS = "meshiPotential/Rot1SolvateCoarse/Pairwise_CB.dat";
    public final String[] TWO_TORSIONS_PARAMETERS = {/*"meshiPotential/parametersPhiChiCoil.dat",
    ...
    public final String[] FLAT_RAMACH_PARAMETERS = {//"meshiPotential/flatRamachCoil.dat",
    ...
    public final String[] SOLVATE_WIDE_ATTRACTION_PARAMETERS = {"meshiPotential/SolvateMESHI2Tsai.dat",
    ...
    public final String[] COMPOSITE_PROPENSITY_3D_PARAMETERS = {"meshiPotential/CompositePropensity2D.dat",
    ...
    public final String[] SOLVATE_PARAMETERS_ALT2 = {"meshiPotential/SolvateCend.dat",
						"meshiPotential/SolvateCp1.dat",
						"meshiPotential/SolvateCp2.dat",
						"meshiPotential/SolvateCvalAtp1.dat",
						"meshiPotential/SolvateCvalAtp2.dat",
    ...
    public final String[] NEW_SOLVATE_PARAMETERS = {"meshiPotential/SolvateCend.dat",
    		"meshiPotential/SolvateCp1.dat",
    		"meshiPotential/SolvateCp2.dat",
    		"meshiPotential/SolvateCvalAtp1.dat",
    		"meshiPotential/SolvateCvalAtp2.dat",
